...
public class BannerMoviesAdapter extends PagerAdapter {
    ...
    public BannerMoviesAdapter(Context context, List<BannerMovies> bannerMoviesList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        Glide.with(context).load(bannerMoviesList.get(position).getImageUrl()).into(imageView);
